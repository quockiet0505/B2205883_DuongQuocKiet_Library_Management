  ...
  <div class="card p-3 shadow-sm">
    ...
    <form @submit.prevent="handleSubmit">
      <div class="row g-3">
        ...
        <!-- Borrow date (temporary) -->
        <div class="col-md-4">
          <label class="form-label">Borrow Date (Temp)</label>
          <input v-model="form.borrowDate" type="date" class="form-control" required />
        </div>

        <!-- Return date (temporary) -->
        <div class="col-md-4">
          <label class="form-label">Return Date (Temp: +7 days)</label>
  ...
  data() {
    ...
    return {
      form: {
        ...
        bookId: "",
        quantity: 1,
        borrowDate: today,   // tạm thời
        returnDate: next7,   // tạm thời
      },
    };
  },
